    ...
    <>
        ...
        <div className="min-h-screen w-full grid grid-cols-1 place-content-center px-4 max-w-4xl mx-auto">
            ...
            <form className="mx-auto w-full rounded-md">
                ...
                <button type="submit" className="w-full border border-white rounded-xl bg-black active:bg-blue-700 text-white hover:bg-blue-700 lg:hover:scale-[1.01] transition-all duration-500 py-1">submit</button>
