...
const ClassAssessment = () => {
  ...
  return (
    <div>
      <Crumbs url={`teacherdashboard/classes/${class_id}/performance`} title={'class performance'} heading={`assessment summary`}/>
      {/* page heading */}
      ...
      <Transcripts  dashboard={'teacher'} assessment={false} date={false} section={`classes/${class_id}/performance/${assessment_id}`} icon={false} transcripts={grades} subject={false} submitter={false} />
