...
const AccountCreation = () => {
  ...
  return (
    <div>
      ...
      <p className="w- full text-center py-3 px-4 bg-white rounded-xl text-gray-500">we use the ID number for verification purposes, as a child cannot be expected to have an email address or phone number</p>
      <StudentCreationFrom/>
