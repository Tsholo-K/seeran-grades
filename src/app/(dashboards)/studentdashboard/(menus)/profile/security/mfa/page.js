...
const MultiFactorAuthentication = () => {
  return (
    <div className="w-full relative grid grid-cols-1 place-content-center ">
      ...
      <SingleMenuLink title={'Phone number'} url={'/studentdashboard/profile/security/mfa/phonenumber'} border={true}/>
      {/* email */}
      <p className="text-sm text-gray-400 pl-2 mt-5 pb-1">email</p>
      <SingleMenuLink title={'Email'} url={'/studentdashboard/profile/security/mfa/email'} border={true}/>
